                        ...
                        {activeTab === "all" && !projectFilter ? (
                            <>
                                ...
                                <button
                                    onClick={() => setNewTROpen(true)}
                                    disabled={creating}
                                    className="mt-4 inline-flex items-center gap-1 rounded-full bg-foreground px-3 py-1 text-xs font-medium text-primary-foreground hover:bg-foreground transition-colors shadow-md disabled:opacity-40"
                                >
                                    + Create New
                                </button>
                            </>
