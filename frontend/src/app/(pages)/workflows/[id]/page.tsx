    ...
    if (notFound || !workflow) {
        return (
            <div className="flex-1 flex items-center justify-center">
                <p className="text-muted-foreground/70 font-serif">Workflow not found.</p>
            </div>
        );
    }
                        ...
                        <div className="flex-1">
                            {columns.length === 0 ? (
                                <div className="flex flex-col items-start py-24 w-full max-w-xs mx-auto">
                                    <Plus className="h-8 w-8 text-muted-foreground/50 mb-4" />
                                    ...
                                    {!readOnly && (
                                        <button
                                            onClick={() => setAddColumnOpen(true)}
                                            className="mt-4 inline-flex items-center gap-1 rounded-full bg-foreground px-3 py-1 text-xs font-medium text-primary-foreground hover:bg-foreground transition-colors shadow-md"
                                        >
                                            + Add Column
                                        </button>
                                    )}
