    ...
    return (
        ...
        >
            ...
            <div className="flex items-end gap-1 pr-2 pt-2 bg-muted">
                        ...
                        return (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="shrink-0 rounded-full p-0.5 text-muted-foreground/70 hover:bg-muted-foreground/30 hover:text-foreground"
                                >
                                    <X className="h-3 w-3" />
                                </button>
                            </div>
                ...
                <button
                    onClick={onCloseAll}
                    className="shrink-0 mb-1 ml-1 rounded-lg p-1.5 text-muted-foreground/70 hover:bg-secondary hover:text-foreground"
                    title="Close panel"
                >
                    <X className="h-4 w-4" />
                </button>
