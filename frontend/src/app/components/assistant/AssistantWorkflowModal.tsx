            ...
            >
                        ...
                        {loading ? (
                            ...
                            filteredWorkflows.map((wf) => (
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-3 text-xs text-left transition-colors border-b border-border/50 ${
                                        selected?.id === wf.id
                                            ? "bg-muted"
                                            : "hover:bg-muted"
                                    }`}
                ...
                <div className="border-t border-border px-4 py-3 flex items-center justify-end gap-2 shrink-0">
                    ...
                    <button
                        ...
                        onClick={handleUse}
                        disabled={!selected}
                        className="rounded-lg bg-foreground px-4 py-1.5 text-sm font-medium text-primary-foreground hover:bg-foreground disabled:opacity-40 transition-colors"
                    >
                        Use
                    </button>
                </div>
