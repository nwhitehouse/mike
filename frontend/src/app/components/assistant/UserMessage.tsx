                ...
                {(workflow || hasFiles) && (
                    <div className="flex flex-wrap justify-end gap-1.5 mt-3">
                        ...
                        {hasFiles && files.map((f, i) => {
                            ...
                            const chipBase =
                                "inline-flex items-center gap-1 pl-2 pr-2.5 py-0.5 rounded-full text-xs text-white shadow border border-black bg-black";
                            ...
                            if (clickable) {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`${chipBase} cursor-pointer hover:bg-gray-800 transition-colors`}
