    ...
    return (
        <div className="flex items-center gap-2">
            <button
                ...
                className="inline-flex items-center gap-1 rounded-lg border border-foreground bg-foreground px-2 py-1.5 text-xs font-medium text-primary-foreground hover:bg-foreground disabled:opacity-50 disabled:cursor-not-allowed"
            >
