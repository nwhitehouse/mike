...
export function DocViewModal({
    ...
    return createPortal(
        <div
            className="fixed inset-0 z-100 flex items-center justify-center bg-primary/40"
            onClick={onClose}
        >
            <div
                ...
                <div className="flex items-center justify-between px-5 py-3 shrink-0">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                        <button
                            ...
                            className="flex items-center justify-center w-6 h-6 rounded hover:bg-muted text-muted-foreground/70 hover:text-foreground transition-colors"
                        >
                        ...
                        {onDelete && (
                            <button
                                ...
                                className="flex items-center justify-center w-6 h-6 rounded hover:bg-red-50 text-muted-foreground/70 hover:text-red-500 transition-colors"
                            >
