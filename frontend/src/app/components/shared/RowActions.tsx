    ...
    return (
        <>
            <button
                ...
                className="flex items-center justify-center w-6 h-6 rounded text-foreground hover:text-foreground hover:bg-muted transition-colors leading-none"
            >
            ...
            {open && (
                <div
                    ...
                    className="z-50 w-48 rounded-xl border border-border bg-card shadow-lg overflow-hidden"
