                            ...
                            >
                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    >
                                        <input
                                            ...
                                            className="flex-1 text-2xl font-serif text-foreground placeholder:text-muted-foreground focus:outline-none bg-transparent"
                                            autoFocus={index === 0}
                                        />
                                        <button
                                            type="button"
                                        ...
                                        {presetsOpenIndex === index && (
                                            <div className="absolute left-0 right-0 top-full mt-1 z-50 rounded-xl border border-border bg-card shadow-lg overflow-y-auto max-h-64">
                                                <button
                                                    ...
                                                    className="w-full px-3 py-2 text-left text-sm text-muted-foreground/70 hover:bg-muted transition-colors border-b border-border"
                                                >
                                                    No Preset
                                                </button>
                                                {PROMPT_PRESETS.map(
                                    ...
                                    {columns.length > 1 && (
                                        <button
                                            ...
                                            className="mt-1.5 rounded-lg p-1.5 text-muted-foreground/50 transition-colors hover:bg-muted hover:text-muted-foreground"
                                        >
                                            <X className="h-4 w-4" />
                                        </button>
                                    )}
                                ...
                                <div className="mt-4">
                                    ...
                                    <DropdownMenu>
                                        <DropdownMenuTrigger asChild>
                                            <button className="mt-1 flex items-center justify-between rounded-md border border-border bg-card px-2 py-1.5 text-sm text-foreground hover:border-input focus:outline-none">
                                ...
                                {column.format === "tag" && (
                                    <div className="mt-3">
                                        ...
                                        <div className="mt-1 flex flex-wrap gap-1.5 rounded-md border border-border px-2 py-1.5 focus-within:border-input">
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-1.5 text-sm text-muted-foreground transition-colors hover:text-foreground disabled:text-muted-foreground/50"
                                    >
                                        {generatingIndices.includes(index) ? (
                                ...
                                <textarea
                                    ...
                                    placeholder="Write the analysis prompt — describe what Olava should extract from each document for this column…"
                                    className="mt-2 w-full rounded-md border border-border px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:border-input focus:outline-none bg-transparent resize-none leading-relaxed"
                                />
                            </div>
                        ))}
                    ...
                    <div className="flex items-center justify-between border-t border-border px-6 py-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="rounded-lg bg-foreground px-5 py-2 text-sm font-medium text-primary-foreground hover:bg-foreground disabled:opacity-40 transition-colors"
                            >
