                ...
                >
                    <div className="px-6 pt-3 pb-4 space-y-5 overflow-y-auto flex-1">
                        ...
                        <input
                            ...
                            className="w-full text-2xl font-serif text-foreground placeholder:text-muted-foreground focus:outline-none bg-transparent"
                            autoFocus
                        />
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className="flex items-center justify-between w-full rounded-lg border border-border px-3 py-2 text-sm hover:border-input focus:outline-none bg-card transition-colors"
                                >
                        ...
                        {!isProjectMode && <div className="space-y-3">
                            ...
                            >
                                <span
                                    className={`relative inline-flex h-5 w-9 shrink-0 rounded-full transition-colors duration-200 ${underProject ? "bg-foreground" : "bg-secondary"}`}
                                >
                                    <span
