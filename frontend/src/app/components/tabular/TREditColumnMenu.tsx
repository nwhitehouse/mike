                ...
                >
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                            ...
                            className="rounded p-0.5 text-muted-foreground/70 hover:bg-muted hover:text-muted-foreground transition-colors"
                        >
                    ...
                    <input
                        ...
                        className="mt-1 w-full rounded-md border border-border px-2 py-1 text-foreground text-xs font-normal focus:border-input focus:outline-none"
                    />
                    ...
                    <div className="mt-3">
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <button className="mt-1 flex w-full items-center justify-between rounded-md border border-border bg-card px-2 py-1 text-xs text-foreground hover:border-input focus:outline-none">
                    ...
                    {format === "tag" && (
                        <div className="mt-2">
                            <div className="flex flex-wrap gap-1 rounded-md border border-border px-2 py-1 focus-within:border-input min-h-[28px]">
                                {tags.map((tag, tagIdx) => (
                                    <span
                                        key={tag}
                                ...
                                <input
                                    ...
                                    className="min-w-[60px] flex-1 bg-transparent text-xs text-foreground placeholder:text-muted-foreground/50 focus:outline-none"
                                />
                            </div>
                        </div>
                    )}
                    ...
                    <div className="mt-3">
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="inline-flex items-center gap-1 text-xs text-muted-foreground transition-colors hover:text-foreground disabled:text-muted-foreground/50"
                            >
                                {generating ? (
                        ...
                        <textarea
                            ...
                            className="mt-2 w-full rounded-lg border border-border bg-card px-3 py-2 text-xs font-normal text-foreground placeholder:text-muted-foreground/50 focus:border-input focus:outline-none resize-none leading-relaxed"
                        />
                    </div>
