                ...
                <div className="px-5 py-4 flex flex-col gap-4 flex-1 overflow-y-auto">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <button
                            ...
                            className={`relative inline-flex h-5 w-9 shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ${allowEdit ? "bg-foreground" : "bg-secondary"}`}
                        >
                                ...
                                {existingShares.map((share) => (
                                    <div key={share.id} className="flex items-center justify-between py-1">
                                        ...
                                        <div className="flex items-center gap-3 shrink-0">
                                            <span className="text-xs text-muted-foreground/70">{share.allow_edit ? "Can edit" : "Read-only"}</span>
                                            <button
